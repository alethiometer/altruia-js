    ...
    return (
        <div className="container">
            ...
            <div className="header">
                ...
                <div className="user-NFT">
                    ...
                    {account ? <div className="nft-desc">
                        ...
                        <div>
                    <a href="https://testnets.opensea.io/collection/altruia-x-givewell-donation-collection" className="opensea" target="_blank">View the collection on OpenSea!</a>
                    </div>
                </div>
            </div>
            ...
            <h4 className="gallery-header">Tokens of appreciation</h4>
                <p className="gallery-header">We'll mint an NFT to represent your contribution to GiveWell.</p>
